...
const Projects = () => {
  const project = projects[0]; // Using the first project as the featured project
  ...
  return (
    <section id="projects" className="py-24 relative">
      <div className="container mx-auto px-6">
        ...
        {/* Featured Project */}
        <Card className="overflow-hidden bg-gradient-to-br from-card to-card/50 border-2 border-primary/50 hover:border-primary transition-all duration-500 group relative">
